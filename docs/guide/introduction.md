...
The current release is a pre-production alpha. Geth is the reference
integration. Other clients are candidates until their conformance matrices are
continuously green. See [Compatibility](/compatibility) and
